  ...
  <body>
    ...
    <main>
      ...
      if (isset($_SESSION["user_id"])) {
        ...
        <div class='main'>
          <h1>Report Bug</h1>
          <h2>please provide as many deatails a posable</h2>
          <div class='outdiv'>
            <form class='indiv' action='http://notflix.com/template/proccessbug.php' method='post' id='bugform'>
            <input type='hidden' name='uid' value='$uid'>
            <textarea name='bug' class='textbox'></textarea><br>
