  ...
  <body>
    ...
    <main>
      ...
      if (isset($_SESSION["user_id"])) {
        ...
        echo "
        <div class='main'>
          <h1>please submit your requested show or movie</h1>
          <h2>please provide any aditional detail and imdb page</h2>
          <div class='outdiv'>
            <form class='indiv' action='http://notflix.com/template/proccessrequest.php' method='post' id='requestform'>
            <input type='hidden' name='uid' value='$uid'>
            <textarea name='request' class='textbox'></textarea><br>
